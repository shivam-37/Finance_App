                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input class="w-full bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl py-3 px-4 text-gray-700 dark:text-gray-300 leading-tight focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all" id="month" type="month" name="month" value="{{ date('Y-m') }}" required>
                                </div>
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input class="w-full pl-8 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl py-3 px-4 text-gray-700 dark:text-gray-300 leading-tight focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all" id="amount" type="number" step="0.01" name="amount" placeholder="0.00" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select class="w-full bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl py-3 px-4 text-gray-700 dark:text-gray-300 leading-tight focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all" id="category_id" name="category_id" required>
                                    ...
                                    @else
                                        <option value="" disabled selected>Select a category to budget...</option>
