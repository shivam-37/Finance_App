                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                ...
                                <form action="{{ route('budgets.destroy', $budget) }}" method="POST" class="inline">
                                    @csrf @method('DELETE')
                                    <button type="button" onclick="window.dispatchEvent(new CustomEvent('open-confirm', { detail: { title: 'Delete Budget', message: 'This budget will be permanently removed.', form: this.closest('form') } }))" class="p-1.5 rounded-lg text-gray-400 hover:text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-500/10 transition-colors">
