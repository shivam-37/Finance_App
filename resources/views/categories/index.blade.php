                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <div class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                ...
                                <form action="{{ route('categories.destroy', $category) }}" method="POST" class="inline">
                                    @csrf @method('DELETE')
                                    <button type="button" onclick="document.querySelector('[x-data=\'confirmModal\']').__x.$data.show('Delete Category', 'All transactions in this category will lose their category.', this.closest('form'))" class="p-2 rounded-xl text-gray-400 hover:text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-500/10 transition-colors" title="Delete">
