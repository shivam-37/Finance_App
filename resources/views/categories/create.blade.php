            ...
            <div class="animate-fade-in-up bg-white/80 dark:bg-gray-800/80 backdrop-blur-md overflow-hidden shadow-xl sm:rounded-3xl border border-slate-100 dark:border-gray-700/50 relative">
                ...
                <div class="p-10 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('categories.store') }}">
                        @csrf
                        <div class="space-y-6" x-data="{ type: '{{ old('type', 'expense') }}' }">
                            <div>
                            ...
                            <div>
                                ...
                                <input class="w-full bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl py-3 px-4 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" type="text" name="name" value="{{ old('name') }}" required placeholder="e.g. Food & Dining">
                            </div>
                            ...
                            <div class="pt-4 flex items-center justify-end gap-4">
                                ...
                                <button class="bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 text-white font-semibold py-3 px-8 rounded-xl shadow-lg shadow-indigo-200/50 dark:shadow-none transition-all hover:scale-105 active:scale-95" type="submit">Create Category</button>
                            </div>
                        </div>
                    </form>
                </div>
