                    ...
                    <form method="POST" action="{{ route('categories.update', $category) }}">
                        ...
                        <div class="space-y-6" x-data="{ type: '{{ $category->type }}' }">
                            ...
                            <div>
                                ...
                                <input class="w-full bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl py-3 px-4 text-gray-700 dark:text-gray-300 leading-tight focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all" id="name" type="text" name="name" value="{{ $category->name }}" placeholder="e.g. Groceries, Salary, Utilities" required>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="relative w-14 h-14 rounded-full overflow-hidden shadow-inner border-2 border-slate-200 dark:border-gray-700 focus-within:ring-2 focus-within:ring-emerald-500 focus-within:border-transparent transition-all">
                                        <input class="absolute -top-2 -left-2 w-20 h-20 cursor-pointer" id="color" type="color" name="color" value="{{ $category->color }}" required>
                                    </div>
