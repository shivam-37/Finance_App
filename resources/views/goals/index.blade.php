                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <div class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                ...
                                <form action="{{ route('goals.destroy', $goal) }}" method="POST" class="inline">
                                    @csrf @method('DELETE')
                                    <button type="button" onclick="window.dispatchEvent(new CustomEvent('open-confirm', { detail: { title: 'Delete Savings Goal', message: 'Are you sure? This will remove this piggy bank and all virtual funds in it.', form: this.closest('form') } }))" class="p-2 rounded-xl text-gray-400 hover:text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-500/10 transition-colors" title="Delete">
